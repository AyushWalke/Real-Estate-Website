...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "3dc26d55-d1b3-41e5-a7d6-488c6c85aaaa");
    ...
    if (data.success) {
      setResult("");
      toast.success("Form Submitted Seccessfully");
      event.target.reset();
    } else {
    ...
    className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
            ...
            <div className='my-6 text-left'>
                Message
                <textarea name="Message" placeholder='Message' required className='w-full border border-gay-300 rounded py-3 px-4 mt-2 h-48 resize-none'></textarea>
            </div>
